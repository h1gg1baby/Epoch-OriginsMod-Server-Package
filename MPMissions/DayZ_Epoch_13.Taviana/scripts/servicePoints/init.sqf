...
_servicePointClasses = ["US_WarfareBVehicleServicePoint_Base_EP1","TK_WarfareBVehicleServicePoint_EP1","Map_A_FuelStation_Feed","Land_A_FuelStation_Feed","FuelPump_DZ","Land_Ind_tankSmall","Land_cisterna","Land_a_stationhouse","MAP_Ind_TankBig"]; // service point classes, You can also use dayz_fuelpumparray by its self for all the default fuel pumps.
