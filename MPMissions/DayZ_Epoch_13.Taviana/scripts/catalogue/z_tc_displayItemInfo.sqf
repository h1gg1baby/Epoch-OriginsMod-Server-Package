...
_displayText = getText(configFile >> "CfgMagazines" >> _class >> "descriptionShort");
	...
	if (_unittype != "") then {
		[_class] call trader_preview;
	};

if (Z_SingleCurrency) then {
	_formattedText = format [
		"<br /><br /><br /><br /><br /><img image='%1'  size='7' align='center'/><br />" +
		"<t color='#bcbcbc' size='0.7'>%8: </t><t color='#ffffff' size='0.7'>%2</t><br />" +
		"<t color='#bcbcbc' size='0.7'>%9: </t><t color='#ffffff' size='0.7'>%3</t><br />" +
		"<t color='#22e300' size='0.7'>%11: </t><t color='#ffffff' size='0.7'>%6 %7</t><br />" +
		"<t color='#f7f300' size='0.7'>%10: </t><t color='#ffffff' size='0.7'>%5 %7</t><br />",
		_picture,
		_display,
		_class,
		'lazy',
	...
	_formattedText = format [
		"<img image='%1'  size='7' align='center'/><br />" +
