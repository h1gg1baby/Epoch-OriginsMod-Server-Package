...
if (!isDedicated) then {
	...
	dayz_quickSwitch = true; //Enable quick weapon switch,
	...
	*/
	...
	ZSC_bankObjects = ["MAP_pc","Laptop_EP1","SatPhone","Info_Board_EP1"]; // Array of objects that are available for banking i.e: ["Suitcase","Info_Board_EP1","Laptop_EP1","SatPhone"]
	...
	ZSC_ZombieCoins = [true,[0,100]]; // First value activate coins on zombies, second value from 0 - 1000 coins on each zombie. Coin for zombies are handled directly in check wallet.
