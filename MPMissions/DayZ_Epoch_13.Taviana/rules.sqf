...
_messages = [
	["Press F3 for hiding the Origins-Status-Menu.<br />This setting will be saved.", "Welcome "+(name player)],
	["World", worldName],
	["Attention", "Press F3 for hiding the Origins-Status-Menu<br />This setting will be saved."],
	["Info", "Press F3 for hiding the Origins-Status-Menu"],
	...
	["By the way", "Press F3 for hiding the Origins-Status-Menu.<br />This setting will be saved."]
];
