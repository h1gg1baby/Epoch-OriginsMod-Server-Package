private ['_item', '_type','_picture',"_class","_display","_transportMaxWeapons","_transportMaxMagazines","_transportmaxBackpacks","_buyPrice","_sellPrice","_buyCurrency","_sellCurrency","_formattedText","_fuelCapacity","_maxSpeed","_armor","_seats","_weapons","_weapons2","_config","_wepText","_turret","_text"];
...
_wepText = "";
{
	...
	if (Z_SingleCurrency) then {
		_formattedText = format [
			"<br /><br /><br /><br /><br /><img image='%1'  size='8' align='center'/><br /><br />" +
			"<t color='#bcbcbc' size='0.7'>%10: </t><t color='#ffffff' size='0.7'>%2</t><br />" +
			"<t color='#bcbcbc' size='0.7'>%11: </t><t color='#ffffff' size='0.7'>%3</t><br />" +
			"<t color='#22e300' size='0.7'>%13: </t><t color='#ffffff' size='0.7'>%6 %7</t><br />" +
			"<t color='#22e300' size='0.7'>%12: </t><t color='#ffffff' size='0.7'>%5 %7</t><br />" +
		...
		_formattedText = format [
			"<img image='%1'  size='8' align='center'/><br /><br />" +
	...
	(findDisplay 711197 displayCtrl 7445) ctrlSetStructuredText parseText _formattedText;
